...
from ...models.property_escapes_model_title_printuh_oh import PropertyEscapesModelTitlePrintuhOh
from ...types import Response


def _get_kwargs(
    *,
    body: PropertyEscapesModelTitlePrintuhOh,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/property-escapes",
    }
