# escapes-client
A client library for accessing escapes"

## Usage
First, create a client:

```python
from escapes_client import Client
...
```python
from escapes_client import AuthenticatedClient
...
from escapes_client.api.my_tag import get_my_data_model
from escapes_client.types import Response
...
1. Any endpoint which did not have a tag will be in `escapes_client.api.default`
